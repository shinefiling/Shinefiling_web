...
const LLPClosureRegistration = ({ isLoggedIn, isModal = false, onClose, planProp }) => {
    ...
    const validateStep = (step) => {
        ...
        let isValid = true;
        if (step === 1) {
            if (!formData.businessName) { newErrors.businessName = "LLP Name required"; isValid = false; }
            if (!formData.llpin) { newErrors.llpin = "LLPIN required"; isValid = false; }
    ...
    const handleSubmit = async () => {
        ...
        processPayment({
            ...
            description: `Payment for LLP Closure - ${plans[selectedPlan].title}`,
            prefill: {
                        ...
                        <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm">
                            ...
                            <div className="grid md:grid-cols-2 gap-4">
                                <div className="md:col-span-2">
                                    ...
                                    <input type="text" name="businessName" value={formData.businessName} onChange={handleChange} placeholder="Enter LLP Name" className={`w-full p-3 rounded-lg border ${errors.businessName ? 'border-red-500' : 'border-gray-200'} focus:ring-2 focus:ring-blue-500 bg-gray-50`} />
                                </div>
                                <div>
                                    <label className="text-xs font-bold text-gray-500 mb-1 block">LLPIN</label>
                                    <input type="text" name="llpin" value={formData.llpin} onChange={handleChange} placeholder="AAX-0000" className={`w-full p-3 rounded-lg border ${errors.llpin ? 'border-red-500' : 'border-gray-200'} bg-white`} />
                                </div>
                                <div>
                ...
                return (
                    <div className="bg-white p-6 rounded-xl shadow-lg border border-gray-100 text-center animate-in zoom-in-95">
                        ...
                        <button onClick={handleSubmit} disabled={loading || isPaymentProcessing} className="w-full py-4 bg-green-600 text-white rounded-xl font-bold shadow-lg hover:bg-green-700 hover:shadow-xl transition flex items-center justify-center gap-2 disabled:opacity-50">
                            {loading || isPaymentProcessing ? 'Processing Payment...' : 'Pay Now & Close LLP'}
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="md:hidden flex flex-col gap-1 w-full max-w-[calc(100vw-80px)]">
                                <div className="flex items-center gap-2 truncate">
                                    <span className="font-bold text-slate-800 text-sm truncate">LLP Closure</span>
                                </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 md:p-8">
                        {success ? (
                            <div className="text-center py-10">
                                ...
                                <p className="text-gray-500 mt-2">Your application for LLP Closure has been received.</p>
