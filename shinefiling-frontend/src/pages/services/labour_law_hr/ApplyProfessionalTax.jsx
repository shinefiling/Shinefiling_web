...
const ApplyProfessionalTax = ({ isLoggedIn, isModal = false, planProp, onClose }) => {
    ...
    const plans = {
        ptec: { title: "PTEC Registration", serviceFee: 999 },
        ptrc: { title: "PTRC Registration", serviceFee: 1499 },
        combo: { title: "PT Combo (PTEC+PTRC)", serviceFee: 2199 }
    };

    const billDetails = useMemo(() => {
        const selectedPricing = plans[planType] || plans.ptec;
    ...
    const submitApplication = async () => {
        ...
        processPayment({
            ...
            description: `Payment for ${billDetails.planName} - Professional Tax Registration`,
            prefill: {
        ...
        switch (currentStep) {
            case 1: return (
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                        <h3 className="font-bold text-slate-800 mb-4 text-sm flex items-center gap-2"><Receipt size={18} className="text-orange-600" /> BUSINESS DETAILS</h3>
                    ...
                    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {[
                                ...
                                { id: 'proof', label: 'Entity Registration Proof' },
                                { id: 'directors', label: 'Directors/Partners List' }
                            ].map((doc) => (
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="space-y-2 text-sm bg-slate-50 p-4 rounded-xl border border-slate-100">
                            ...
                            <div className="flex justify-between"><span>State</span><span className="font-bold">{formData.state}</span></div>
            ...
            case 4: return (
                <div className="bg-white p-6 rounded-xl border border-gray-100 shadow-lg text-center animate-in zoom-in-95">
                    ...
                    <p className="text-xs text-slate-500 mb-6 font-medium">Professional Tax Registration Fee</p>
                    ...
                    <div className="min-h-[64px] bg-white border-b flex items-center justify-between px-4 md:px-6 py-2 shrink-0 z-20">
                        <div className="flex flex-col">
                            <div className="md:hidden flex flex-col gap-1 w-full max-w-[calc(100vw-80px)]">
                                <span className="font-bold text-slate-800 text-sm truncate">PT Registration</span>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 md:p-8">
                        {isSuccess ? (
                            <div className="text-center py-10">
                                ...
                                <p className="text-gray-500 mt-2 font-medium">We have received your registration details for {formData.businessName}.</p>
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    <div className="w-full lg:w-80 shrink-0">
                        <div className="bg-[#043E52] text-white p-6 rounded-3xl shadow-xl relative overflow-hidden">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-full blur-3xl -mr-10 -mt-10"></div>
                            <h2 className="font-bold text-xl mb-6 relative z-10 flex items-center gap-2 max-w-[80%]"><Receipt size={18} fill="#ED6E3F" stroke="none" /> PT Registration</h2>
                    ...
                    <div className="flex-1">
                        {isSuccess ? (
                            <div className="bg-white p-12 rounded-3xl shadow-xl border border-gray-100 text-center">
                                ...
                                <p className="text-gray-500 mb-8 max-w-sm mx-auto font-medium">Your PT registration request has been submitted.</p>
