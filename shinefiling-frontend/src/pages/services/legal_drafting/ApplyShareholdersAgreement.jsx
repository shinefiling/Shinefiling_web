...
const ApplyShareholdersAgreement = ({ isLoggedIn, isModal = false, onClose, planProp }) => {
    ...
    const handleSubmit = async () => {
        ...
        processPayment({
            ...
            description: `Payment for ${billDetails.planName} - Shareholders Agreement Drafting`,
            prefill: {
                    ...
                    <div className="flex flex-col justify-center">
                        <div className="md:hidden flex flex-col gap-1 w-full max-w-[calc(100vw-80px)]">
                            <div className="flex items-center gap-2 truncate">
                                <span className="font-bold text-slate-800 text-sm truncate">Shareholders Agreement</span>
                            </div>
