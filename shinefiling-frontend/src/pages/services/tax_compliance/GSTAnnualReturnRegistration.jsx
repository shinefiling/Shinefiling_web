...
const GstAnnualReturnRegistration = ({ isLoggedIn, isModal = false, planProp, onClose }) => {
    ...
    const plans = {
        basic: {
            price: 1499,
            title: 'Basic Filing',
            features: ["GSTR-9 Filing", "upto 2Cr Turnover", "Email Support"],
            color: 'bg-white border-slate-200'
        },
        standard: {
            price: 2499,
            title: 'Standard Filing',
            features: ["GSTR-9 & 9C", "upto 5Cr Turnover", "CA Certified"],
            recommended: true,
        ...
        premium: {
            ...
            features: ["GSTR-9 & 9C", "> 5Cr Turnover", "Complete Reconciliation"],
    ...
    const submitApplication = async () => {
        ...
        processPayment({
            ...
            description: `Payment for ${plans[selectedPlan]?.title} - GST Annual Return`,
            prefill: {
            ...
            onSuccess: async (response) => {
                ...
                try {
                    ...
                    const apiResponse = await submitGstAnnualReturn(finalPayload);
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <input name="businessName" value={formData.businessName} onChange={handleInputChange} placeholder="Registered Legal Name" className={`md:col-span-2 p-2 text-sm border rounded-lg ${errors.businessName ? 'border-red-500' : ''}`} />
                            ...
                            <input type="number" name="annualTurnover" value={formData.annualTurnover} onChange={handleInputChange} placeholder="Annual Turnover (₹)" className="p-2 text-sm border rounded-lg w-full" />
                        </div>
                    </div>
                </div>
            );
                ...
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 gap-3">
                            {['Balance Sheet & P/L', 'Audit Report (if applicable)', 'GSTR-3B/1 Annual Summary'].map((doc, i) => (
            ...
            <div className="flex flex-col md:flex-row h-[85vh] overflow-hidden bg-white">
                ...
                <div className="hidden md:flex w-72 bg-[#043E52] text-white flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="flex-1 space-y-2 overflow-y-auto pr-2 custom-scrollbar">
                        {['Entity Details', 'Upload Data', 'Review Info', 'Payment'].map((step, i) => (
                            <div key={i}
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="md:hidden flex flex-col gap-1 w-full max-w-[calc(100vw-80px)]">
                                <div className="flex items-center gap-2 truncate">
                                    <span className="font-bold text-slate-800 text-sm truncate">Annual Return</span>
                                </div>
                            ...
                            <h2 className="hidden md:block font-bold text-slate-800 text-lg">
                                ...
                                {currentStep === 2 && "Data Upload"}
                                {currentStep === 3 && "Review Filing"}
                ...
                <div className="flex gap-8">
                    <div className="w-72 hidden lg:block space-y-4">
                        <div className="bg-white p-4 rounded-xl shadow-sm border space-y-2">
                            {['Entity Details', 'Upload Data', 'Review Info', 'Payment'].map((s, i) => (
