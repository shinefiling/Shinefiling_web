...
const GSTR1Registration = ({ isLoggedIn, isModal = false, planProp, onClose }) => {
    ...
    const plans = {
        monthly: {
            ...
            features: ["Sales Invoice Upload", "HSN Summary", "B2B & B2C Filing"],
            color: 'bg-white border-slate-200'
        },
        quarterly: {
            price: 999,
            title: 'Quarterly Filing',
            features: ["3 Months Filing", "QRMP Support", "IFF Support"],
            recommended: true,
        ...
        annual: {
            price: 4499,
            title: 'Annual Plan',
            features: ["12 Months Filing", "GSTR-9 Included", "Yearly Reconciliation"],
    ...
    const submitApplication = async () => {
        ...
        processPayment({
            ...
            description: `Payment for ${plans[selectedPlan]?.title} - GSTR-1 Registration`,
            prefill: {
    ...
    const renderStepContent = () => {
        switch (currentStep) {
            case 1: return (
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        ...
                        <h3 className="font-bold text-slate-800 mb-3 text-sm flex items-center gap-2"><Building size={16} /> ENTITY KYC</h3>
            ...
            case 2: return (
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        <h3 className="font-bold text-slate-800 mb-3 text-sm flex items-center gap-2"><Briefcase size={16} /> SALES METRICS</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            <input type="number" name="turnover" value={formData.turnover} onChange={handleInputChange} placeholder="Total Taxable Sales (₹)" className={`md:col-span-2 p-2 text-sm border rounded-lg w-full ${errors.turnover ? 'border-red-500' : ''}`} />
                            <input type="number" name="invoiceCount" value={formData.invoiceCount} onChange={handleInputChange} placeholder="Invoice Count" className="p-2 text-sm border rounded-lg w-full" />
            ...
            case 3: return (
                <div className="space-y-4 animate-in fade-in slide-in-from-right-4">
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm">
                        <h3 className="font-bold text-slate-800 mb-3 text-sm">DATA REPOSITORY</h3>
                        <div className="grid grid-cols-1 gap-3">
                            {['Sales Register / Invoices', 'HSN Summary Item-wise'].map((doc, i) => (
            ...
            case 4: return (
                <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100">
                    ...
                    <div className="p-4 bg-gray-50 rounded-lg space-y-2 text-sm">
                        ...
                        <div className="flex justify-between"><span>Sales Value</span><span className="font-bold text-blue-600">₹{Number(formData.turnover).toLocaleString()}</span></div>
                    </div>
                </div>
            );
            case 5: return (
            ...
            <div className="flex flex-col md:flex-row h-[85vh] overflow-hidden bg-white">
                ...
                <div className="hidden md:flex w-72 bg-[#043E52] text-white flex-col p-6 shrink-0 relative overflow-hidden">
                    ...
                    <div className="flex-1 space-y-2 overflow-y-auto pr-2 custom-scrollbar">
                        {['Entity Info', 'Sales', 'Documents', 'Review', 'Payment'].map((step, i) => (
                            <div key={i}
                        ...
                        <div className="flex flex-col justify-center">
                            ...
                            <div className="md:hidden flex flex-col gap-1 w-full max-w-[calc(100vw-80px)]">
                                <div className="flex items-center gap-2 truncate">
                                    <span className="font-bold text-slate-800 text-sm truncate">GSTR-1</span>
                                </div>
                ...
                <div className="flex gap-8">
                    <div className="w-72 hidden lg:block space-y-4">
                        <div className="bg-white p-4 rounded-xl shadow-sm border space-y-2">
                            {['Entity', 'Sales', 'Docs', 'Review', 'Payment'].map((s, i) => (
